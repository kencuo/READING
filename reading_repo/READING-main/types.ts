...
export interface Book {
  ...
  boundPersonaId?: string; // Optional bound user persona
  boundCharacterId?: string; // Optional bound character
}
...
export type ReaderThemeId = 'beige' | 'green' | 'blue' | 'pink' | 'peach' | 'night';

export interface ReaderMoreAppearanceSettings {
  readingMode: 'scroll' | 'page';
  readerThemeId: ReaderThemeId;
  readerFabOffsetPx: number;
